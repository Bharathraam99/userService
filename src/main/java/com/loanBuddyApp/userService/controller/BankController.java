...
public class BankController {
    ...
    public ResponseEntity<?> transferMoney(@RequestHeader("Authorization") String authorizationHeader, @RequestBody TransactionRequest transactionRequest) throws Exception {
        try{
